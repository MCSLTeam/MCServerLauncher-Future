...
public sealed class V2ClientProtocolTests
{
    ...
    private static class GoldenJson
    {
        ...
        private const string AuditRecordJson = "{\"timestamp\":\"2026-01-01T00:00:00+00:00\",\"principal\":\"owner-a\",\"plugin_id\":null,\"method\":\"mcsl.instance.start\",\"permission\":\"mcsl.instance.start\",\"target\":\"" + Id + "\",\"plan_id\":null,\"plan_hash\":null,\"operation_id\":null,\"succeeded\":true,\"error_code\":null,\"confirmed_by\":null,\"detail\":null}";
        private const string MonitoringSampleJson = "{\"timestamp\":\"2026-01-01T00:00:00+00:00\",\"gap\":false,\"system_cpu_percent\":5.5,\"memory_used_kilobytes\":16384,\"memory_total_kilobytes\":32768,\"instances\":[{\"instance_id\":\"" + Id + "\",\"name\":\"demo\",\"status\":\"running\",\"cpu_percent\":12.5,\"memory_bytes\":1024,\"silent_seconds\":3.5}],\"disk_total_bytes\":1024,\"disk_free_bytes\":512,\"events\":[{\"instance_id\":\"" + Id + "\",\"kind\":\"status_changed\",\"status\":\"crashed\",\"previous_status\":\"running\",\"at\":null},{\"instance_id\":\"" + RuleId + "\",\"kind\":\"ready_timeout\",\"status\":\"starting\",\"previous_status\":null,\"at\":null}],\"dropped_events\":null}";
        ...
        private const string AutomationUnresponsivePolicyJson = "{\"id\":\"" + RuleId + "\",\"name\":\"unresponsive-guard\",\"enabled\":true,\"trigger\":{\"type\":\"instance.unresponsive\",\"instance_id\":\"" + Id + "\",\"silent_seconds\":300},\"actions\":[{\"type\":\"instance.maintenance\",\"instance_id\":\"" + Id + "\",\"duration_seconds\":600,\"reason\":\"held for an operator\"},{\"type\":\"audit.record\",\"message\":\"instance went quiet\",\"severity\":\"Warning\"}],\"cooldown_seconds\":300,\"max_executions_per_day\":20}";
        private const string AutomationStatusDurationPolicyJson = "{\"id\":\"44444444-4444-4444-4444-444444444444\",\"name\":\"stuck-stopped\",\"enabled\":true,\"trigger\":{\"type\":\"instance.status_duration\",\"instance_id\":null,\"status\":\"stopped\",\"duration_seconds\":900},\"actions\":[{\"type\":\"instance.restart_suppression\",\"instance_id\":null,\"duration_seconds\":1800,\"reason\":\"stopped on purpose\"}],\"cooldown_seconds\":300,\"max_executions_per_day\":20}";
        private const string AutomationDiskPolicyJson = "{\"id\":\"55555555-5555-5555-5555-555555555555\",\"name\":\"disk-guard\",\"enabled\":true,\"trigger\":{\"type\":\"metric.sustained\",\"metric\":\"system_disk_percent\",\"instance_id\":null,\"threshold\":95,\"sustained_seconds\":300},\"actions\":[{\"type\":\"audit.record\",\"message\":\"disk is nearly full\",\"severity\":\"Error\"}],\"cooldown_seconds\":300,\"max_executions_per_day\":20}";
        private const string AutomationPolicySetJson = "{\"policies\":[" + AutomationPolicyJson + "," + AutomationUnresponsivePolicyJson + "," + AutomationStatusDurationPolicyJson + "," + AutomationDiskPolicyJson + "],\"version\":3}";
        private const string AutomationSuppressionJson = "{\"instance_id\":\"" + Id + "\",\"scope\":\"all\",\"until_utc\":\"2026-01-01T00:10:00+00:00\",\"reason\":\"held for an operator\",\"policy_id\":\"" + RuleId + "\"}";
        ...
        internal static string For(Type type)
        {
            ...
            if (type == typeof(AuditQuery)) return "{\"maximum_records\":100,\"not_before\":\"2026-01-01T00:00:00+00:00\",\"not_after\":\"2026-01-02T00:00:00+00:00\",\"principal\":\"owner-a\",\"method\":\"mcsl.instance.start\",\"target\":\"" + Id + "\",\"owner_principal\":\"owner-a\"}";
            if (type == typeof(AuditQueryResult)) return "{\"records\":[" + AuditRecordJson + "],\"dropped_records\":0}";
            ...
            if (type == typeof(AutomationGetResult)) return "{\"policy_set\":" + AutomationPolicySetJson + ",\"suppressions\":[" + AutomationSuppressionJson + "]}";
