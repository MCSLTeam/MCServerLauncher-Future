...
public class DaemonOutboundTransportSerializationTests
{
    ...
    {
        AssertFileDoesNotContain("src/MCServerLauncher.Daemon/Remote/WsActionPlugin.cs", "JsonConvert.SerializeObject(");
        AssertFileDoesNotContain("src/MCServerLauncher.Daemon/Remote/Action/ActionExecutor.cs", "JsonConvert.SerializeObject(");
        AssertFileDoesNotContain("src/MCServerLauncher.Daemon/Remote/WsEventPlugin.cs", "JsonConvert.SerializeObject(");
    }
    ...
    {
        AssertFileDoesNotContain("src/MCServerLauncher.Daemon/Remote/WsEventPlugin.cs", "JToken.FromObject(");
    }
    ...
    public void WsEventPluginFile_NormalAndPreparedPaths_ShareBuildWirePayloadUtf8()
    {
        ...
        var source = ReadSourceFile("src/MCServerLauncher.Daemon/Remote/WsEventPlugin.cs");
