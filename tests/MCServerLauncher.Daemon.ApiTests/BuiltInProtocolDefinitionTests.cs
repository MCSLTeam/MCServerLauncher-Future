...
public sealed class BuiltInProtocolDefinitionTests
{
    ...
    public void NamedTypedDescriptorsAreTheExactFrozenCatalogInstances()
    {
        ...
        [
            ...
            BuiltInProtocolDefinitions.SendInstanceCommand, BuiltInProtocolDefinitions.OpenConsole, BuiltInProtocolDefinitions.ResizeConsole, BuiltInProtocolDefinitions.CloseConsole, BuiltInProtocolDefinitions.CreateInstance,
    ...
    public void BuiltInDefinitionsContainTheExactFrozenRpcAndEventNames()
    {
        var expectedRpcs = new[]
        {
            ...
            "mcsl.instance.catalog.get", "mcsl.instance.command.send", "mcsl.instance.console.close", "mcsl.instance.console.open",
