...
internal class ActionReturnCodeJsonConverter : JsonConverter<ActionReturnCode>
{
        ...
        JsonSerializer serializer)
    {
        ...
        if (id == null) throw new JsonSerializationException("Can't parse action return code");
        if (!Enum.IsDefined(typeof(ActionReturnCode), id))
...
{
    [JsonProperty(Required = Required.Always, PropertyName = "action")]
