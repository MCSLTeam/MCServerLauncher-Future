...
namespace MCServerLauncher.Common.ProtoType.Action.Parameters
{
    ...
    public sealed record GetPermissionsParameter : IActionParameter;

    public sealed record PingParameter : IActionParameter;

    public sealed record GetJavaListParameter : IActionParameter;
    ...
    public sealed record GetAllStatusParameter : IActionParameter;

    public sealed record GetSystemInfoParameter : IActionParameter;
}
...
namespace MCServerLauncher.Common.ProtoType.Action.Results
{
    ...
    public sealed record UnsubscribeEventResult : IActionResult;
    ...
    public sealed record FileUploadCancelResult : IActionResult;
    ...
    public sealed record FileDownloadCloseResult : IActionResult;
    ...
    public sealed record SendToInstanceResult : IActionResult;

    public sealed record KillInstanceResult : IActionResult;
