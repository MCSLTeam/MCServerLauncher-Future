...
public static class BuiltInProtocolDefinitions
{
    ...
    public static RpcDescriptor<EmptyRequest, PermissionsResult> GetAuthPermissions { get; } = Rpc("mcsl.auth.permissions.get", Authenticated, Protocol.EmptyRequest, Protocol.PermissionsResult, "auth", "Get permissions", "Gets the authenticated connection permissions.");
    public static RpcDescriptor<EmptyRequest, PingResult> PingDaemon { get; } = Rpc("mcsl.daemon.ping", Authenticated, Protocol.EmptyRequest, Protocol.PingResult, "daemon", "Ping daemon", "Gets the daemon time for connection-latency measurement.");
    public static RpcDescriptor<PathTransferRequest, UnitResult> CopyDirectory { get; } = Rpc("mcsl.directory.copy", new("mcsl.daemon.file.copy.directory"), Application.PathTransferRequest, Protocol.UnitResult, "files", "Copy directory", "Copies a contained directory.");
    public static RpcDescriptor<PathRequest, UnitResult> CreateDirectory { get; } = Rpc("mcsl.directory.create", new("mcsl.daemon.file.create.directory"), Application.PathRequest, Protocol.UnitResult, "files", "Create directory", "Creates a contained directory.");
    public static RpcDescriptor<DeleteDirectoryRequest, UnitResult> DeleteDirectory { get; } = Rpc("mcsl.directory.delete", new("mcsl.daemon.file.delete.directory"), Application.DeleteDirectoryRequest, Protocol.UnitResult, "files", "Delete directory", "Deletes a contained directory.");
    public static RpcDescriptor<PathRequest, DirectoryDetails> GetDirectoryInfo { get; } = Rpc("mcsl.directory.info.get", new("mcsl.daemon.file.info.directory"), Application.PathRequest, Application.DirectoryDetails, "files", "Get directory information", "Gets contained directory metadata and entries.");
    public static RpcDescriptor<PathTransferRequest, UnitResult> MoveDirectory { get; } = Rpc("mcsl.directory.move", new("mcsl.daemon.file.move.directory"), Application.PathTransferRequest, Protocol.UnitResult, "files", "Move directory", "Moves a contained directory.");
    public static RpcDescriptor<PathRenameRequest, UnitResult> RenameDirectory { get; } = Rpc("mcsl.directory.rename", new("mcsl.daemon.file.rename.directory"), Application.PathRenameRequest, Protocol.UnitResult, "files", "Rename directory", "Renames a contained directory.");
    public static RpcDescriptor<EventSubscriptionRequest, UnitResult> SubscribeEvent { get; } = Rpc("mcsl.event.subscribe", Authenticated, Protocol.EventSubscriptionRequest, Protocol.UnitResult, "events", "Subscribe to event", "Subscribes the connection to a typed server event.");
    public static RpcDescriptor<EventSubscriptionRequest, UnitResult> UnsubscribeEvent { get; } = Rpc("mcsl.event.unsubscribe", Authenticated, Protocol.EventSubscriptionRequest, Protocol.UnitResult, "events", "Unsubscribe from event", "Removes the connection subscription for a typed server event.");
    public static RpcDescriptor<PathTransferRequest, UnitResult> CopyFile { get; } = Rpc("mcsl.file.copy", new("mcsl.daemon.file.copy.file"), Application.PathTransferRequest, Protocol.UnitResult, "files", "Copy file", "Copies a contained file.");
    public static RpcDescriptor<PathRequest, UnitResult> DeleteFile { get; } = Rpc("mcsl.file.delete", new("mcsl.daemon.file.delete.file"), Application.PathRequest, Protocol.UnitResult, "files", "Delete file", "Deletes a contained file.");
    public static RpcDescriptor<FileSessionReference, UnitResult> CloseDownload { get; } = Rpc("mcsl.file.download.close", new("mcsl.daemon.file.download"), Protocol.FileSessionReference, Protocol.UnitResult, "files", "Close download", "Closes a download session.");
    public static RpcDescriptor<DownloadOpenRequest, DownloadSession> OpenDownload { get; } = Rpc("mcsl.file.download.open", new("mcsl.daemon.file.download"), Application.DownloadOpenRequest, Application.DownloadSession, "files", "Open download", "Opens a bounded binary download session.");
    public static RpcDescriptor<DownloadChunkRequest, DownloadReadResult> ReadDownload { get; } = Rpc("mcsl.file.download.read", new("mcsl.daemon.file.download"), Application.DownloadChunkRequest, Protocol.DownloadReadResult, "files", "Read download chunk", "Requests the next binary download chunk.");
    public static RpcDescriptor<PathRequest, FileDetails> GetFileInfo { get; } = Rpc("mcsl.file.info.get", new("mcsl.daemon.file.info.file"), Application.PathRequest, Application.FileDetails, "files", "Get file information", "Gets contained file metadata.");
    public static RpcDescriptor<PathTransferRequest, UnitResult> MoveFile { get; } = Rpc("mcsl.file.move", new("mcsl.daemon.file.move.file"), Application.PathTransferRequest, Protocol.UnitResult, "files", "Move file", "Moves a contained file.");
    public static RpcDescriptor<PathRenameRequest, UnitResult> RenameFile { get; } = Rpc("mcsl.file.rename", new("mcsl.daemon.file.rename.file"), Application.PathRenameRequest, Protocol.UnitResult, "files", "Rename file", "Renames a contained file.");
    public static RpcDescriptor<FileSessionReference, UnitResult> CancelUpload { get; } = Rpc("mcsl.file.upload.cancel", new("mcsl.daemon.file.upload"), Protocol.FileSessionReference, Protocol.UnitResult, "files", "Cancel upload", "Cancels an upload session.");
    public static RpcDescriptor<FileSessionReference, UnitResult> CloseUpload { get; } = Rpc("mcsl.file.upload.close", new("mcsl.daemon.file.upload"), Protocol.FileSessionReference, Protocol.UnitResult, "files", "Close upload", "Validates and commits an upload session.");
    ...
    public static RpcDescriptor<InstanceReference, UnitResult> HaltInstance { get; } = Rpc("mcsl.instance.halt", Authenticated, Application.InstanceReference, Protocol.UnitResult, "instances", "Halt instance", "Immediately signals an instance process to halt.");
    public static RpcDescriptor<InstanceLogQuery, InstanceLogResult> GetInstanceLog { get; } = Rpc("mcsl.instance.log.get", Authenticated, Application.InstanceLogQuery, Application.InstanceLogResult, "instances", "Get instance log", "Gets retained log lines for an instance.");
    public static RpcDescriptor<InstanceReference, UnitResult> RemoveInstance { get; } = Rpc("mcsl.instance.remove", Authenticated, Application.InstanceReference, Protocol.UnitResult, "instances", "Remove instance", "Removes a stopped instance.");
    public static RpcDescriptor<InstanceReference, InstanceReport> GetInstanceReport { get; } = Rpc("mcsl.instance.report.get", Authenticated, Application.InstanceReference, Application.InstanceReport, "instances", "Get instance report", "Gets the current report for an instance.");
    public static RpcDescriptor<EmptyRequest, InstanceReportList> ListInstanceReports { get; } = Rpc("mcsl.instance.report.list", Authenticated, Protocol.EmptyRequest, Application.InstanceReportList, "instances", "List instance reports", "Gets current reports for all instances.");
    public static RpcDescriptor<InstanceReference, InstanceSettingsResult> GetInstanceSettings { get; } = Rpc("mcsl.instance.settings.get", Authenticated, Application.InstanceReference, Application.InstanceSettingsResult, "instances", "Get instance settings", "Gets editable settings for an instance.");
    public static RpcDescriptor<UpdateInstanceSettingsRequest, UpdateInstanceSettingsResult> UpdateInstanceSettings { get; } = Rpc("mcsl.instance.settings.update", Authenticated, Application.UpdateInstanceSettingsRequest, Application.UpdateInstanceSettingsResult, "instances", "Update instance settings", "Persists and applies instance settings.");
